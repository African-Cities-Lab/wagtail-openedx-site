...
from wagtail_openedx_site.search import views as search_views
...
urlpatterns = [
    ...
    # User management
    # path("users/", include("wagtail_openedx_site.users.urls", namespace="users")),
    # path("accounts/", include("allauth.urls")),
    # Your stuff: custom urls includes go here
    path("catalog/", include(wagtail_openedx_urls)),
